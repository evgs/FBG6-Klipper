...
Закомментировать включение оверлея видеоускорителя (может встречаться не один раз, закомментировать все вхождения)
...
Также можно попробовать сразу взять настройки из п.10 - сенсоры MKS имеют повторяемость лучше 1%
...
(коэффициенты "Calibration" будут отличаться в зависимости от конкретного экземпляра тачскрина): 
